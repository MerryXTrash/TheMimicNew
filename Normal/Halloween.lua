...
function a2()
   TP.HumanoidRootPart.CFrame = CFrame.new(46.819671630859375, 53.72618865966797, -101.1846694946289)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(144.1282958984375, 52.26311111450195, -35.1242561340332)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(166.00494384765625, 50.83844757080078, -118.5602798461914)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(33.589054107666016, 80.64682006835938, -117.01399993896484)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(-61.31797409057617, 80.71629333496094, -68.9711685180664)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(-38.524452209472656, 65.96051025390625, 10.011377334594727)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(96.82023620605469, 80.71629333496094, -169.1722412109375)
   wait(0.2)
   fire2()
   wait(0.2)
   TP.HumanoidRootPart.CFrame = CFrame.new(42.07787322998047, 65.30133819580078, -136.4564971923828)
   wait(0.2)
   fire2()
   wait(0.2)
end
