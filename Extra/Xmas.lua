...
local function grab()
    for i, v in pairs(game:GetService("Workspace").GameAI.Krampus:GetChildren()) do
	    ...
	    Freeze(true)
            TP.HumanoidRootPart.CFrame = v.CFrame * CFrame.new(0, 0, 12)
            wait(0.2)
            fire()
            fire()
            fire()
...
local Window = Alc:NewWindow('Overflow - Extra Version','The Mimic - Christmas Trial','rbxassetid://134754092492795')
