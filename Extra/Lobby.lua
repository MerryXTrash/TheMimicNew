...
local Window = Alc:NewWindow('Overflow - Extra Version','The Mimic','rbxassetid://134754092492795')
...
local TabFunctions2 = MenuFunctions:AddTab('Quick Lantern','Function','box')
...
local MainSection4 = TabFunctions2:AddSection('Quick','Classic','Quick Get Lantern','box')
local MainSection3 = TabFunctions2:AddSection('Quick','Chapter','Quick Get Lantern','box')
local MainSection2 = TabFunctions2:AddSection('Quick','Gamemode','Quick Get Lantern','box')
...
MainSection:AddButton('Teleport to Jigoku',function(v)
    t(7618863566)
end)

MainSection:AddButton('Teleport to Gamemode',function(v)
    t(7068737459)
end)

MainSection:AddButton('Teleport to Classic',function(v)
    t(15989427413)
end)

MainSection:AddButton('Teleport to Chapter',function(v)
    t(6243699076)
end)



MainSection2:AddButton('Get The Witch Trial Lantern',function(v)
    t(7069191531)
end)

MainSection2:AddButton('Get Halloween Trial',function(v)
    t(7633631511)
end)
...
MainSection3:AddButton('Get Control Chapter 2 Lantern',function(v)
    t(6485056556)
end)

MainSection3:AddButton('Get Control Chapter 3 Lantern',function(v)
    t(6688734395)
end)

MainSection3:AddButton('Get Control Chapter 4 Lantern',function(v)
    t(7265397848)
end)
...
MainSection4:AddButton('Get Classic Badge Chapter 1',function(v)
    t(15996407335)
end)

MainSection4:AddButton('Get Classic Badge Chapter 2',function(v)
    t(15996413469)
end)

MainSection4:AddButton('Get Classic Badge Chapter 3',function(v)
    t(15996417416)
end)
