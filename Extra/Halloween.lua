...
local function Skip()
    if id == 7633631103 or id == 7633631351 then
	_G.skip = true
	while _G.skip do
	wait(0)
        ipt(7633631511)
    ...
    elseif id == 7633631511 then
        TP.HumanoidRootPart.CFrame = CFrame.new(156.75186157226562, 17.099130630493164, -1120.8385009765625) -- b1c1p2
        wait(0.2)
        fire()
    end
end
...
local Window = Alc:NewWindow('Overflow - Extra Version','The Mimic - Halloween Trial','rbxassetid://134754092492795')
