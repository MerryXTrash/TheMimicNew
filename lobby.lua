...
local Window = Alc:NewWindow('Overflow','The Mimic - Lobby','rbxassetid://134204200422920')
...
local MainSection = TabFunctions:AddSection('Event','Jigoku','Teleport to Jigoku [Now]','log-out')
